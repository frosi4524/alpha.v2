...
# // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " WELCOME TO ROSI CENTER STORE VPN ${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
...
clear
# REPO    
REPO="https://raw.githubusercontent.com/frosi4524/alpha.v2/refs/heads/main/"
...
clear
izinsc="https://raw.githubusercontent.com/frosi4524/ijin/refs/heads/main/alpha"
# USERNAME
rm -f /usr/bin/user
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"t.me/ROSIlegend1"}]]}' 
...
bash -c "$(curl -L https://github.com/XTLS/Xray-install/raw/main/install-release.sh)" @ install -u www-data --version $latest_version
    ...
    sudo curl -fsSL https://raw.githubusercontent.com/frosi4524/alpha.v2/refs/heads/main/config/nginx.conf -o /etc/nginx/nginx.conf
...
wget -q https://raw.githubusercontent.com/frosi4524/alpha.v2/refs/heads/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
wget -q -O /etc/default/dropbear https://raw.githubusercontent.com/frosi4524/alpha.v2/refs/heads/main/config/dropbear.conf
...
#OpenVPN
wget https://raw.githubusercontent.com/frosi4524/alpha.v2/refs/heads/main/config/openvpn && chmod +x openvpn && ./openvpn
...
# Ganti Banner
wget -O /etc/kyt.txt https://raw.githubusercontent.com/frosi4524/alpha.v2/refs/heads/main/files/issue.net
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ SCRIPT BY ROSI CENTER VPN TUNNELING ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
echo "Semuanya Berjalan Ok...Terimakasih Telah menggunakan Script ROSI Legend!!"
sleep 1
