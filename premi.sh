...
echo -e "${purple}----------------------------------------------------------${NC}"
echo -e " ›AUTHOR : ${green}ROSI CENTER STORE® ${NC}${YELLOW}(${NC}${green}V 3.5${NC}${YELLOW})${NC}"
echo -e " ›TEAM 🅥🅝: ROSI CENTER STORE ${YELLOW}(${NC} 2025 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ SCRIPT BY ROSI CENTER TUNNELING ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
